...
- **Question History / Back Button** — Add a "← Previous card" button to review the last question. Useful if someone wants to revisit a question they skipped too quickly.
...
- **Constants Organization** — Move magic strings and button labels to dedicated constants section for consistency and future i18n support.
