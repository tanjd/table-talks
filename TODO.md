...
- ✅ **Rate limiting** — Implemented per-chat rate limiting with category-based limits (callbacks, theme selection, card navigation, commands). See [src/bot/rate_limit.py](src/bot/rate_limit.py).
...
- **Configuration Management** — Move hard-coded BOT_USERNAME to environment variable for better configurability.
